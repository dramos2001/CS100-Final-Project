 ...
 * In our game, there will be a main character who is given health and mana at the start. This character can perform specific tasks/actions such as attack, cast spells, heal, etc. These tasks will be inputted by the player. The outcome of those actions will be displayed to the user and will progress the plot further. The character has certain attributes, such as health and mana, that are modified by the gameplay and inputs from the player. For instance, the character's health will be deducted when attacked and their mana will be reduced when they cast a spell.
